...
/**
 * struct passinfo - for pseudo-argment
 * @arg: string array from arg
 * @path: string path for our command
 * @argc: arg count
 * @line_count: this is the error count
 * @err_num: error code for exit()
 * @linecount_flag: count for the line input
 * @fname: filename
 * @env: linked list
 * @environ: copy of environ
 * @history: history code
 * @alias: alias code
 * @env_changed: change of env
 * @status: return status
 * @cmd_buf: pointer to cmd_buf
 * @cmd_buf_type: cmd_type ||, &&, ;
 * @readfd: fd from where to read input
...
/**
 * struct builtin - builtin str and related fn
